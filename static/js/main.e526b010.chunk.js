...
var controls = __webpack_require__(133);
...
var class_circles_Circles=/*#__PURE__*/function(_React$Component){Object(inherits["a" /* default */])(Circles,_React$Component);function Circles(props){var _this;Object(classCallCheck["a" /* default */])(this,Circles);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(Circles).call(this,props));_this.toggle=function(){var _this$props$refGroups=_this.props.refGroupsMethods,_this$props$refGroups2=_this$props$refGroups.circles,moveUp=_this$props$refGroups2.moveUp,moveDown=_this$props$refGroups2.moveDown,_this$props$refGroups3=_this$props$refGroups.squares,moveLeft=_this$props$refGroups3.moveLeft,moveRight=_this$props$refGroups3.moveRight;var toggled=_this.state.toggled;var squaresConfig=_this.state.squaresConfig;if(toggled){if(squaresConfig){moveLeft(_this.increment);}else{moveUp(_this.increment);}}else{if(squaresConfig){moveRight(_this.increment);}else{moveDown(_this.increment);}}if(!squaresConfig){_this.setState(function(_ref){var toggled=_ref.toggled;return{toggled:!toggled};});}};_this.increment=function(){return _this.setState(function(_ref2){var num=_ref2.num;return{num:num+1};});};_this.setCirclesConfig=function(){_this.refGroups=_this.props.getRefGroups({circles:"\n        firstCircle\n        secondCircle\n        thirdCircle\n      "});_this.setState({squaresConfig:false});};_this.setSquaresConfig=function(){_this.refGroups=_this.props.getRefGroups({squares:"\n        firstSquare\n        secondSquare\n        thirdSquare\n      "});_this.setState({squaresConfig:true});};_this.refGroups=props.getRefGroups({circles:"\n        firstCircle\n        secondCircle\n        thirdCircle\n      "});_this.state={toggled:false,num:0,squaresConfig:false};return _this;}Object(createClass["a" /* default */])(Circles,[{key:"render",value:function render(){var _this$state=this.state,num=_this$state.num,squaresConfig=_this$state.squaresConfig;var refGroup;if(squaresConfig){var _this$refGroups$squar=this.refGroups.squares,firstSquare=_this$refGroups$squar.firstSquare,secondSquare=_this$refGroups$squar.secondSquare,thirdSquare=_this$refGroups$squar.thirdSquare;refGroup={firstRef:firstSquare,secondRef:secondSquare,thirdRef:thirdSquare};}else{var _this$refGroups$circl=this.refGroups.circles,firstCircle=_this$refGroups$circl.firstCircle,secondCircle=_this$refGroups$circl.secondCircle,thirdCircle=_this$refGroups$circl.thirdCircle;refGroup={firstRef:firstCircle,secondRef:secondCircle,thirdRef:thirdCircle};}return react_default.a.createElement(react_default.a.Fragment,null,react_default.a.createElement("div",{className:"config config--".concat(squaresConfig?'squares':'circles')},react_default.a.createElement("div",{className:"config__toggle",onClick:this.setCirclesConfig},"Use circles config"),react_default.a.createElement("div",{className:"config__toggle",onClick:this.setSquaresConfig},"Use squares config")),react_default.a.createElement("div",{onClick:this.toggle,className:"circles"},react_default.a.createElement("div",{ref:refGroup.firstRef,className:"circles__first"}),react_default.a.createElement("div",{ref:refGroup.secondRef,className:"circles__second"},num),react_default.a.createElement("div",{ref:refGroup.thirdRef,className:"circles__third"})));}}]);return Circles;}(react_default.a.Component);/* harmony default export */ var class_circles = (react_ref_groupie_default()(class_circles_Circles));
...
var stateless_squares_hook_StatelessSquares=function StatelessSquares(_ref){var num=_ref.num,iterate=_ref.iterate;var _useRefGroups=Object(react_ref_groupie["useRefGroups"])({squares:"\n      firstSquare\n      secondSquare\n      thirdSquare\n    "}),_useRefGroups2=Object(slicedToArray["a" /* default */])(_useRefGroups,3),ready=_useRefGroups2[0],_useRefGroups2$1$squa=_useRefGroups2[1].squares,moveLeft=_useRefGroups2$1$squa.moveLeft,moveRight=_useRefGroups2$1$squa.moveRight,_useRefGroups2$2$squa=_useRefGroups2[2].squares,firstSquare=_useRefGroups2$2$squa.firstSquare,secondSquare=_useRefGroups2$2$squa.secondSquare,thirdSquare=_useRefGroups2$2$squa.thirdSquare;if(!ready){return null;}return react_default.a.createElement("div",{onClick:iterate(moveRight,moveLeft),className:"squares"},react_default.a.createElement("div",{ref:firstSquare,className:"squares__first"}),react_default.a.createElement("div",{ref:secondSquare,className:"squares__second"},num),react_default.a.createElement("div",{ref:thirdSquare,className:"squares__third"}));};/* harmony default export */ var stateless_squares_hook = (with_iterate_state(stateless_squares_hook_StatelessSquares));
...
var objectDestructuringEmpty = __webpack_require__(113);

// CONCATENATED MODULE: ./src/components/halo/halo-hook.js
var halo_hook_HaloHook=function HaloHook(){var _useRefGroups=Object(react_ref_groupie["useRefGroups"])({circles:'halo'}),_useRefGroups2=Object(slicedToArray["a" /* default */])(_useRefGroups,3),ready=_useRefGroups2[0];Object(objectDestructuringEmpty["a" /* default */])(_useRefGroups2[1]);var halo=_useRefGroups2[2].circles.halo;if(!ready){return null;}return react_default.a.createElement("div",{ref:halo,className:"halo"});};/* harmony default export */ var halo_hook = (halo_hook_HaloHook);
...
var usage_variants = __webpack_require__(256);
...
var components = __webpack_require__(258);
...
//# sourceMappingURL=main.e526b010.chunk.js.map